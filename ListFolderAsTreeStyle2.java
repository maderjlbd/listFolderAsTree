...
public class ListFolderAsTreeStyle2 extends DirectoryWalker {
	//遍历目录深度限制，0表示不限制
	private int limitDeep = 0;
	public static void main(String[] args) throws IOException {
    	long start = System.currentTimeMillis();
        new ListFolderAsTreeStyle2().startListFiles(new File("E:\\000000000000000000000000_gcbi_micro\\gcbi-ch"));
        long end = System.currentTimeMillis();
		System.out.println( "执行时间： " + ( end - start ) + "毫秒。" );
    } 
	
    public ListFolderAsTreeStyle2() {
        super();  
    }  
    public ListFolderAsTreeStyle2(String extension,String newExtension) {
    	super();  
